...
description: "Politique de confidentialité de Le Magazine Lulli : données collectées, finalités, durées de conservation, cookies et droits RGPD."
...
Le responsable du traitement des données collectées sur Le Magazine Lulli est l'éditeur du site, joignable à l'adresse contact@magazine.lulli-sur-la-toile.com. Toute question relative à la protection des données peut lui être adressée directement.

## Principe de collecte minimale

Le Magazine Lulli ne recueille que les données strictement nécessaires au fonctionnement du site et au traitement des demandes reçues. Aucune donnée n'est vendue, louée ni cédée à des tiers à des fins commerciales.
